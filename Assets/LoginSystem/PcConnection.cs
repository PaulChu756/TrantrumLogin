...
{
    public string loginUrl = "34.208.221.68/Login.php";
    public string registerURL = "34.208.221.68/Register.php";
    public string checUsernameUrl = "34.208.221.68/CheckUsername.php";
    public string checEmailUrl = "34.208.221.68/CheckEmail.php";
    public string forgotUrl = "34.208.221.68/Forgot.php";
    public string newPasswordURL = "34.208.221.68/NewPassword.php";

    public string secretGameKey = "Trantrum300!";
    public string secretServerKey = "Trantrum300!";
